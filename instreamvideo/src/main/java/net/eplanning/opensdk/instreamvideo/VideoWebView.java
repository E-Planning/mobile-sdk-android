...
import net.eplanning.opensdk.ANVideoPlayerSettings;
import net.eplanning.opensdk.AdActivity;
import net.eplanning.opensdk.AdViewRequestManager;
import net.eplanning.opensdk.BrowserAdActivity;
...
import net.eplanning.opensdk.viewability.ANOmidAdSession;
        ...
        new Handler().postDelayed(new Runnable() {
            ...
            public void run() {
                ...
                // Fatal exception in android v4.x in TextToSpeech
                    ...
                    Clog.e(Clog.baseLogTag, Clog.getString(net.eplanning.opensdk.R.string.apn_webview_failed_to_destroy), e);
                }
            }
        }, 1500);
    }
