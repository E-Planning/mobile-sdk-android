...
import net.eplanning.opensdk.ANClickThroughAction;
import net.eplanning.opensdk.ANMultiAdRequest;
import net.eplanning.opensdk.Ad;
import net.eplanning.opensdk.AdFetcher;
import net.eplanning.opensdk.AdSize;
import net.eplanning.opensdk.AdType;
import net.eplanning.opensdk.AdView;
import net.eplanning.opensdk.AdViewRequestManager;
import net.eplanning.opensdk.MediaType;
import net.eplanning.opensdk.MultiAd;
import net.eplanning.opensdk.ResultCode;
import net.eplanning.opensdk.SDKSettings;
import net.eplanning.opensdk.VideoOrientation;
...
import net.eplanning.opensdk.viewability.ANOmidViewabilty;
...
public class VideoAd implements Ad, MultiAd {
    ...
    protected void setAllowedSizes() {
        Clog.d(Clog.videoLogTag,
                Clog.getString(net.eplanning.opensdk.R.string.set_allowed_sizes));
