...
import net.eplanning.opensdk.ut.adresponse.CSMSDKAdResponse;
import net.eplanning.opensdk.ut.adresponse.CSRAdResponse;
import net.eplanning.opensdk.ut.adresponse.SSMHTMLAdResponse;
import net.eplanning.opensdk.utils.AdvertisingIDUtil;
...
public class ExecutorForBackgroundTasksTests extends BaseViewAdTest {
    ...
    public void testLoadUrlWithMRAIDExecutorForBackgroundTasks() {
        ...
        assertNotSame(ShadowAsyncTaskNoExecutor.getExecutor(), MockDefaultExecutorSupplier.getInstance().forBackgroundTasks());
        try {
            Class<?> aClass = Class.forName("net.eplanning.opensdk.AdWebView");
    ...
    public void testFireTrackerExecutorForBackgroundTasks() {
        ...
        assertNotSame(ShadowAsyncTaskNoExecutor.getExecutor(), MockDefaultExecutorSupplier.getInstance().forBackgroundTasks());
        try {
            Class<?> aClass = Class.forName("net.eplanning.opensdk.RequestManager");
    ...
    public void testInstantiateNewMediatedSSMAdExecutorForBackgroundTasks() {
        ...
        try {
            ...
            Class<?> aClass = Class.forName("net.eplanning.opensdk.MediatedSSMAdViewController");
    ...
    public void testResponseUrlExecuteExecutorForBackgroundTasks() {
        ...
        try {
            ...
            Class<?> aClass = Class.forName("net.eplanning.opensdk.ResponseUrl");
...
//    }
    ...
    public void testAdViewFireImpressionTrackerExecutorForBackgroundTasks() {
        ...
        assertNotSame(ShadowAsyncTaskNoExecutor.getExecutor(), MockDefaultExecutorSupplier.getInstance().forBackgroundTasks());
        try {
            Class<?> aClass = Class.forName("net.eplanning.opensdk.AdView");
    ...
    public void testMediatedNativeAdControllerFireTrackerExecutorForBackgroundTasks() {
        ...
        try {
            ...
            Class<?> aClass = Class.forName("net.eplanning.opensdk.MediatedNativeAdController");
    ...
    public void testCSRNativeBannerControllerFireTrackerExecutorForBackgroundTasks() {
        ...
        try {
            ...
            Class<?> aClass = Class.forName("net.eplanning.opensdk.CSRNativeBannerController");
            Method met = aClass.getDeclaredMethod("fireTracker", String.class);
            met.setAccessible(true);
    ...
    public void testAdvertisingIdUtilRetrieveAndSetAAIDExecutorForBackgroundTasks() {
        ...
        assertNotSame(ShadowAsyncTaskNoExecutor.getExecutor(), MockDefaultExecutorSupplier.getInstance().forBackgroundTasks());
        try {
            Class<?> aClass = Class.forName("net.eplanning.opensdk.utils.AdvertisingIDUtil");
