...
import net.eplanning.opensdk.VisibilityDetector.VisibilityListener;
import net.eplanning.opensdk.tasksmanager.TasksManager;
import net.eplanning.opensdk.ut.UTAdRequester;
import net.eplanning.opensdk.ut.UTConstants;
import net.eplanning.opensdk.ut.UTRequestParameters;
import net.eplanning.opensdk.ut.adresponse.BaseAdResponse;
import net.eplanning.opensdk.ut.adresponse.RTBHTMLAdResponse;
import net.eplanning.opensdk.ut.adresponse.RTBVASTAdResponse;
...
import net.eplanning.opensdk.utils.ViewUtil;
            ...
            handler.post(new Runnable() {
                ...
                public void run() {
                    ...
                    if (ad.getDisplayable() != null && ad.getResponseData().getAdType().equalsIgnoreCase(UTConstants.AD_TYPE_BANNER)) {
                        ...
                        Settings.ImpressionType impressionType = baseAdResponse == null? null: baseAdResponse.getImpressionType();
                        ...
                        } else if (Settings.ImpressionType.VIEWABLE_IMPRESSION == impressionType && ad.getMediaType() == MediaType.BANNER) {
                            if (baseAdResponse.getImpressionURLs() != null && baseAdResponse.getImpressionURLs().size() > 0) {
                                setImpressionTrackerVariables(baseAdResponse);
                            }
                    ...
                    if (ad.getMediaType() == MediaType.BANNER && Settings.ImpressionType.BEGIN_TO_RENDER == ad.getResponseData().getImpressionType()) {
                        fireOmidImpression();
                    }
