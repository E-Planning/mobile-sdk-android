...
import net.eplanning.opensdk.ut.UTAdResponse;
...
import net.eplanning.opensdk.ut.adresponse.CSMVASTAdResponse;
import net.eplanning.opensdk.ut.adresponse.CSRAdResponse;
import net.eplanning.opensdk.ut.adresponse.RTBNativeAdResponse;
...
public class AdViewRequestManager extends RequestManager {
    ...
    private void fireImpressionTrackerIfBeginToRender(AdView adView, BaseAdResponse response) {
        Settings.ImpressionType impressionType = response.getImpressionType();
        if(impressionType == Settings.ImpressionType.BEGIN_TO_RENDER && adView.getMediaType() != MediaType.INTERSTITIAL) {
