...
public abstract class BaseAdResponse {
    ...
    private Settings.ImpressionType impressionType = Settings.ImpressionType.BEGIN_TO_RENDER;
    ...
    public BaseAdResponse(int width, int height, String adType, ArrayList<String> impressionURLs , ANAdResponseInfo adResponseInfo) {
        ...
        this.impressionType = XandrAd.isEligibleForViewableImpression(adResponseInfo.getBuyMemberId())? Settings.ImpressionType.VIEWABLE_IMPRESSION: Settings.ImpressionType.BEGIN_TO_RENDER;
    }
