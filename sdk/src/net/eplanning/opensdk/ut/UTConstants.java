...
public class UTConstants {
    ...
    public static String REQUEST_BASE_URL_UT = "https://ads.us.e-planning.net/mob/3";
    public static String WEBVIEW_BASE_URL_UT = "https://ads.us.e-planning.net/";
    public static String COOKIE_DOMAIN = "https://mediation.e-planning.net";

    public static String REQUEST_BASE_URL_SIMPLE = "https://ads.us.e-planning.net/ut/3";
    public static String WEBVIEW_BASE_URL_SIMPLE = "https://ads.us.e-planning.net/";
}
