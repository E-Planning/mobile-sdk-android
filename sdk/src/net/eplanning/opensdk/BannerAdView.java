...
import net.eplanning.opensdk.transitionanimation.Animator;
import net.eplanning.opensdk.transitionanimation.TransitionDirection;
import net.eplanning.opensdk.transitionanimation.TransitionType;
...
public class BannerAdView extends AdView implements ScreenEventListener {
    ...
    private VideoOrientation videoOrientation = VideoOrientation.UNKNOWN;
