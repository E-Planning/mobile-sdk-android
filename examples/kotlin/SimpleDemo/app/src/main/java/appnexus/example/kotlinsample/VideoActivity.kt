...
import net.eplanning.opensdk.instreamvideo.Quartile
import net.eplanning.opensdk.instreamvideo.VideoAd
import net.eplanning.opensdk.instreamvideo.VideoAdLoadListener
import net.eplanning.opensdk.instreamvideo.VideoAdPlaybackListener
...
class VideoActivity : AppCompatActivity(),
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        instreamVideoAd.setPublisherId(102246)
